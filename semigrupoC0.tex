...
\begin{proof} \textbf{\underline{Afirmação 1}:} Existem $\delta >0$ e $M\geq 1$ tais 
\begin{equation*}
...
Neste caso, dizemos que $S$ é um \dt{semigrupo uniformemente limitado}. Se, além disso, $M=1$, $S$ é dito um \dt{semigrupo de contrações}. \index{semigrupo das contrações}
