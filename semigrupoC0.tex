...
De fato, que $v_h\in D(A)$ decorre diretamente da Proposição \ref{prop2.11}. Como $S(\cdot)x$ é contínua, pelo Teorema do Valor Médio para integrais, 
...
Como $A_h$ é contínuo, temos que

\begin{align*}
A_hx & =\lim\limits_{n\to +\infty}A_hx_n
=\lim\limits_{n\to +\infty}\frac{1}{h}\left(S(h)x_n-x_n\right)\\
\shortintertext{(Da identidade \eqref{TFC1})}
&  =\lim\limits_{n\to +\infty}\frac{1}{h}\left(\int_0^h S(t)Ax_n\,dt\right)\\
\end{align*}
